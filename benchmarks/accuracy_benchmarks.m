% To be run after 'measure_accuracy' is set in the branch of the FIt-SNE code: https://github.com/linqiaozhi/FIt-SNE/tree/accuracy2
addpath('../FIt-SNE_experimental/linqiaozhi/FIt-SNE')
rng(3)
dim = 3;
sigma_0 = .0001;
cluster_num = 2;
